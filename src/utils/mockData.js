...
// --- Notification Queue (HR-07) mocks ---
...
export const mockNotificationQueue = [
  {
    ...
    templateCode: 'LEAVE_APPLICATION_SUBMITTED',
    ...
    createdAt: '2024-05-01T08:55:00Z',
    sentAt: '2024-05-01T09:02:00Z',
  },
  {
    id: 2,
    recipientId: 102,
    ...
    createdAt: '2024-05-02T09:55:00Z',
    sentAt: '2024-05-02T10:02:00Z',
  },
  {
    id: 3,
    recipientId: 103,
    ...
    relatedEntityId: 125,
    retryCount: 2,
    scheduledAt: '2024-05-03T11:00:00Z',
    createdAt: '2024-05-03T10:55:00Z',
    sentAt: null,
  },
  {
    id: 4,
    ...
    templateCode: 'LEAVE_BALANCE_ALERT',
    subject: 'Leave Balance Alert',
    channel: 'IN_APP',
    status: 'IN_PROGRESS',
    relatedEntityType: 'LEAVE_LEDGER',
    relatedEntityId: 456,
    retryCount: 1,
    scheduledAt: '2024-05-04T12:00:00Z',
    createdAt: '2024-05-04T11:55:00Z',
    sentAt: null,
  },
  {
    id: 5,
    ...
    channel: 'EMAIL',
    status: 'SENT',
    relatedEntityType: 'LEAVE_POLICY',
    relatedEntityId: 789,
    retryCount: 0,
    scheduledAt: '2024-05-05T13:00:00Z',
    createdAt: '2024-05-05T12:55:00Z',
    sentAt: '2024-05-05T13:02:00Z',
  },
  {
    id: 6,
    recipientId: 106,
    recipientName: 'Diana Prince',
    templateCode: 'UPCOMING_HOLIDAY_REMINDER',
    subject: 'Upcoming Holiday Reminder',
    channel: 'EMAIL',
    status: 'QUEUED',
    relatedEntityType: 'HOLIDAY',
    relatedEntityId: 1011,
    retryCount: 0,
    scheduledAt: '2024-05-24T09:00:00Z',
  ...
  },
  {
    ...
    templateCode: 'LEAVE_APPLICATION_NEEDS_ATTENTION',
    subject: 'Leave Application Needs Attention',
    channel: 'EMAIL',
    status: 'FAILED',
    relatedEntityType: 'LEAVE_REQUEST',
    relatedEntityId: 126,
    retryCount: 3,
    scheduledAt: '2024-05-06T14:00:00Z',
    createdAt: '2024-05-06T13:55:00Z',
    sentAt: null,
  },
  {
    id: 8,
    ...
    templateCode: 'HOLIDAY_ADDED',
    subject: 'Holiday Added',
    channel: 'IN_APP',
    status: 'SENT',
    relatedEntityType: 'HOLIDAY',
    relatedEntityId: 1012,
    retryCount: 0,
    scheduledAt: '2024-05-07T15:00:00Z',
    createdAt: '2024-05-07T14:55:00Z',
    sentAt: '2024-05-07T15:02:00Z',
  },
];

export const mockNotificationSummary = {
  totalQueued: 126,
  sentSuccessfully: 98,
  inProgress: 18,
  failed: 10,
...
export const mockDeliveryOverview = [
  { label: 'Sent', value: 98, color: '#10B981' },
  { label: 'In Progress', value: 18, color: '#F59E0B' },
  { label: 'Failed', value: 10, color: '#EF4444' },
];

export const mockNotificationTypes = [
  { type: 'Leave Application', count: 44, percentage: 34.9 },
  { type: 'Leave Approval', count: 32, percentage: 25.4 },
  { type: 'Leave Rejection', count: 18, percentage: 14.3 },
  { type: 'Leave Balance Alert', count: 15, percentage: 11.9 },
  { type: 'Policy Updates', count: 10, percentage: 7.9 },
  { type: 'Holiday Reminders', count: 7, percentage: 5.6 },
];
